...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'nombre', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'apellidos', '' . "\0" . 'App\\Entity\\User' . "\0" . 'telefono', '' . "\0" . 'App\\Entity\\User' . "\0" . 'idEmpresa', '' . "\0" . 'App\\Entity\\User' . "\0" . 'apiToken'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIdEmpresa(?string $idEmpresa): \App\Entity\User
    {
