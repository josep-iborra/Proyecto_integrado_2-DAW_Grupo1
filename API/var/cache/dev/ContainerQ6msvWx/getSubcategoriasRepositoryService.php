 ...
 */
class getSubcategoriasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SubcategoriasRepository' shared autowired service.
     *
     * @return \App\Repository\SubcategoriasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SubcategoriasRepository.php';

        return $container->privates['App\\Repository\\SubcategoriasRepository'] = new \App\Repository\SubcategoriasRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')));
    }
}
